# Contador de ocorrências
  ...
  da busca aparece dentro do conteúdo de texto. Implemente esta lógica dentro do método `contaOcorrencias` da classe
  `ContadorDeOcorrencias`. Veja alguns exemplos de entrada e saída:
